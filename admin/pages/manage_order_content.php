<?php
    if(isset($_GET['status'])){
        ...
        if($_GET['status']=='delete'){
            $message=$obj_super_admin->delete_order_by_id($order_id);
        }
    }
            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <a class="btn btn-info" href="view_order.php?id=<?php echo $order_info['order_id']; ?>" title="view Order">
                            ...
                            <a class="btn btn-info" href="edit_order.php?id=<?php echo $order_info['order_id']; ?>" title="Edit">
